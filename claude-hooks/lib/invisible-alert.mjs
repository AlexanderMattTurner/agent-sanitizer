...
export function instructionsLoadedGapNotice(sessionId) {
  ...
  return (
    ...
    "scan-loaded-instructions (`grep -rl InstructionsLoaded ~/.claude .claude " +
    "2>/dev/null`, which covers an installed plugin's hooks.json as well as the " +
    "settings files; wiring it restores the coverage), a Claude Code " +
